...
void setup() {
  ...
  if(Serial.available())
  {
    ...
    String hora = valores.substring(0, index1);
    int index2 = valores.indexOf(',',index1 + 1);
    String minuto = valores.substring(index1 + 1, index2);
    int index3 = valores.indexOf(',',index2 + 1);
    String dia = valores.substring(index2 + 1, index3);
    int index4 = valores.indexOf(',',index3 + 1);
    String mes = valores.substring(index3 +1, index4);

    String anio = valores.substring(index4 +1);
    hora.toInt();
    minuto.toInt();
    dia.toInt();
    mes.toInt();
